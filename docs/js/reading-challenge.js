  ...
  section.innerHTML = `
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      <div class="flex items-start justify-between gap-4 mb-6">
        <div>
          <h2 class="text-xl font-semibold">📚 ${data.year} Reading Challenge</h2>
          <p class="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div class="text-right">
          ...
          <div class="text-xs text-gray-500 dark:text-gray-400">of annual goal</div>
        </div>
      </div>
      ...
      <div class="mb-6 flex justify-center">
        <div class="relative w-44 h-44">
          ...
          <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">${percent}% complete</div>
          </div>
        </div>
      </div>
...
function bookCard(book) {
  ...
  const dateRead = escapeHtml(book.dateRead || "");
      ...
      ${
        coverUrl
          ? `<img
              ...
              loading="lazy"
              onerror="this.outerHTML='<div class=&quot;h-40 flex items-center justify-center bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-semibold text-lg&quot;>${initials}</div>'"
            />`
          : `<div class="h-40 flex items-center justify-center bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-semibold text-lg">${initials}</div>`
      }
      <div class="p-3">
        <div class="text-sm font-medium leading-tight">${title}</div>
        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">${author}</div>
